...
public final class CommandServiceClient_b {
    ...
    private final ServiceConnection f = new CommandServiceClientConnection_i(
            this);
    ...
    private CommandResult_k c() throws RemoteException {
        CommandResult_k k1;
        try {
            a.trace("Blocking for result from service");
            k1 = (CommandResult_k) c.take();
    ...
    public final CommandResult_k a(n n1) throws RemoteException {
        n1.a(null);
        return c();
    }

    public final CommandResult_k a(r r1, FailedReason_a a1)
            throws RemoteException {
        r1.a(new com.amazon.android.framework.task.command.h(this, a1));
        return c();
    }

    public final CommandResult_k a(w w)
            throws CommandServiceNotInstalledKiwiException_g,
            CommandServiceBindFailureKiwiException_f, RemoteException {
        boolean flag;
        if (b != null)
            flag = true;
        else
        ...
        if (!flag) {
            ...
            intent.setClassName("com.amazon.venezia",
            ...
            try {
                ...
                if (KiwiLogger.TRACE_ON) {
                    ...
                    a.trace((new StringBuilder())
                            .append("Kiwi.BindService Time: ").append(l1 - l)
                            .toString());
                }
            } catch (InterruptedException interruptedexception) {
    ...
    public final void a() {
        ...
        StringBuilder stringbuilder = (new StringBuilder())
                .append("Finishing CommandServiceClient, unbinding service: ");
        boolean flag;
        if (b != null)
            flag = true;
        else
