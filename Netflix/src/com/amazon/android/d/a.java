...
public final class a
{
	...
	public static void a()
	{
		...
		if (Thread.currentThread().getId() != l)
			a((new StringBuilder()).append("Executing thread must be thread: ").append(l).append(", was: ").append(Thread.currentThread().getId()).toString());
	}

	public static void a(Object obj, String s)
	{
		if (obj == null)
			a((new StringBuilder()).append("Argument: ").append(s).append(" cannot be null").toString());
	}
