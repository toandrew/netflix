...
public abstract class RelativeExpirable_c extends Expirable_b {
    ...
    public final Date getExpiration() {
        LOGGER.trace((new StringBuilder())
                .append("RelativeExpiration duration: ")
                .append(getExpirationDurationInSeconds())
                .append(", expirable: ").append(this).toString());
        Date date = new Date(instantiation.getTime() + 1000L
                * getExpirationDurationInSeconds());
        LOGGER.trace((new StringBuilder())
                .append("Expiration should occur at time: ").append(date)
                .toString());
        return date;
    }
