...
public abstract class Expirable_b implements
    ...
    private void notifyObservers() {
        for (Iterator iterator = observers.iterator(); iterator.hasNext(); ((d) iterator
                .next()).observe(this))
            ;
    }
    ...
    private void scheduleExpiration() {
        ...
        taskManager.enqueueAtTime(TaskPipelineId.BACKGROUND, a1,
                getExpiration());
    }
    ...
    public void expire() {
        ...
        if (KiwiLogger.TRACE_ON)
            LOGGER.trace((new StringBuilder()).append("Expiring: ")
                    .append(this).toString());
        doExpiration();
        if (KiwiLogger.TRACE_ON)
            LOGGER.trace((new StringBuilder())
                    .append("Notifying Observers of expiration: ").append(this)
                    .toString());
        notifyObservers();
    }
