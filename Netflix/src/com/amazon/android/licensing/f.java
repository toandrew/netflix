...
public final class f {
    ...
    public f(SignedToken_d d1) throws SignedTokenParseFailureKiwiException_b {
        a = a("checksum", d1);
        b = a("customerId", d1);
        c = a("deviceId", d1);
        e = a("packageName", d1);
    ...
    private static Date b(String s, SignedToken_d d1)
        ...
        try {
            ...
            throw new SignedTokenParseFailureKiwiException_b(
                    "INVALID_FIELD_VALUE", (new StringBuilder()).append(s)
