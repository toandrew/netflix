...
public final class LicenseKillTask_b extends c
{
	...
	public final void execute()
	{
		...
		if (isWorkflowChild())
			quitParentWorkflow();
		PromptContent promptcontent = (PromptContent)b.a("LICENSE_FAILURE_CONTENT");
		com.amazon.android.framework.prompt.c c1;
		if (promptcontent != null)
		{
			if (KiwiLogger.TRACE_ON)
				a.trace((new StringBuilder()).append("Fetched failure content from store: ").append(promptcontent).toString());
			b.a.c("LICENSE_FAILURE_CONTENT");
		} else
		{
			promptcontent = i.e;
		}
		c1 = new com.amazon.android.framework.prompt.c(promptcontent);
		c.present(c1);
	}
