	...
	implements b
{
	...
	private Kiwi(Application application1, boolean drmfull)
	{
		...
		if (KiwiLogger.TRACE_ON)
		{
			...
			LOGGER.trace((new StringBuilder()).append("Application: ").append(application1.getPackageName()).toString());
			LOGGER.trace((new StringBuilder()).append("DRM: ").append(drmfull).toString());
			LOGGER.trace("---------------------------------------------------");
		}
		...
		if (KiwiLogger.TRACE_ON)
		{
			...
			LOGGER.trace((new StringBuilder()).append("Kiwi.Constructor Time: ").append(l1 - l).toString());
		}
	}
	...
	{
		if (KiwiLogger.TRACE_ON)
			LOGGER.trace((new StringBuilder()).append(s).append(" called on context: ").append(context).append(" when ").append("Kiwi is dead, ignoring...").toString());
	}
...
_L1:
		boolean flag = com.amazon.android.m.a.a(s, s1, instance.authKeyLoader.a());
		return flag;
		com.amazon.android.h.a a1;
		a1;
		LOGGER.trace((new StringBuilder()).append("Unable to validate signature: ").append(a1.getMessage()).toString());
_L4:
		return false;
_L2:
		LOGGER.trace("Kiwi was not yet initialized - cannot do the IAP call");
...
_L3:
	...
	public static boolean onActivityResult(Activity activity, int i, int j, Intent intent)
	{
	...
	public static void onCreate(Activity activity, boolean flag)
	{
		...
		{
			long l1 = System.currentTimeMillis();
			LOGGER.trace((new StringBuilder()).append("Kiwi.ActivityOnCreate Time: ").append(l1 - l).toString());
		}
	}
	...
	public static void onCreate(Service service, boolean flag)
	{
		...
		{
			long l1 = System.currentTimeMillis();
			LOGGER.trace((new StringBuilder()).append("Kiwi.ServiceOnCreate Time: ").append(l1 - l).toString());
		}
	}
	...
	public static Dialog onCreateDialog(Activity activity, int i)
	{
		...
		{
			long l1 = System.currentTimeMillis();
			LOGGER.trace((new StringBuilder()).append("Kiwi.ActivityOnCreateDialog Time: ").append(l1 - l).toString());
		}
		return null;
	}
	...
	public static void onDestroy(Activity activity)
	{
		...
		{
			long l1 = System.currentTimeMillis();
			LOGGER.trace((new StringBuilder()).append("Kiwi.ActivityOnDestroy Time: ").append(l1 - l).toString());
		}
	}
	...
	public static void onDestroy(Service service)
	{
		...
		{
			long l1 = System.currentTimeMillis();
			LOGGER.trace((new StringBuilder()).append("Kiwi.ServiceOnDestroy Time: ").append(l1 - l).toString());
		}
	}
	...
	public static void onPause(Activity activity)
	{
		...
		{
			long l1 = System.currentTimeMillis();
			LOGGER.trace((new StringBuilder()).append("Kiwi.ActivityOnPause Time: ").append(l1 - l).toString());
		}
	}
	...
	public static void onResume(Activity activity)
	{
		...
		{
			long l1 = System.currentTimeMillis();
			LOGGER.trace((new StringBuilder()).append("Kiwi.ActivityOnResume Time: ").append(l1 - l).toString());
		}
	}
	...
	public static void onStart(Activity activity)
	{
		...
		{
			long l1 = System.currentTimeMillis();
			LOGGER.trace((new StringBuilder()).append("Kiwi.ActivityOnStart Time: ").append(l1 - l).toString());
		}
	}
	...
	public static void onStop(Activity activity)
	{
		...
		{
			long l1 = System.currentTimeMillis();
			LOGGER.trace((new StringBuilder()).append("Kiwi.ActivityOnStop Time: ").append(l1 - l).toString());
		}
	}
	...
	private static boolean preProcess(String s, Context context)
	{
		...
		if (KiwiLogger.TRACE_ON)
			LOGGER.trace((new StringBuilder()).append(s).append(": ").append(context).toString());
		if (isInitialized())
		{
			return true;
		} else
