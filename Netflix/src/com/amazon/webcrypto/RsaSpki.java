...
public class RsaSpki
{
	...
	private final byte mRsaSpkiObjectIdentifier[] = {
	...
	public RsaSpki()
	{
		...
		if (!getBase64Encoded().equals(""))
	...
	private void findNextTag(byte byte0)
		throws SpkiParsingException
	{
		...
		throws SpkiParsingException
	{
		...
		if ((0x80 & mBase64DecodedData[j]) == 128)
		{
			...
			while (--l >= 0) 
			{
				j++;
				incGlobalOffset(1);
				k = (int)((double)k + Math.pow(2D, l * 8) * (double)byte2uint(mBase64DecodedData[j]));
			}
		} else
		{
