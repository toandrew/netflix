...
public class JsonHelper
{
		...
		throws JSONException
	{
		...
		if (obj instanceof Map)
		{
			...
			Map map = (Map)obj;
			Object obj2;
			for (Iterator iterator = map.keySet().iterator(); iterator.hasNext(); ((JSONObject) (obj1)).put(obj2.toString(), toJSON(map.get(obj2))))
				obj2 = iterator.next();
		...
		{
			obj1 = new JSONArray();
			for (Iterator iterator1 = ((Iterable)obj).iterator(); iterator1.hasNext(); ((JSONArray) (obj1)).put(iterator1.next()));
		} else
		{
			obj1 = obj;
		}
