	...
	implements h
{
	...
	public static h a(IBinder ibinder)
	{
		if (ibinder == null)
			return null;
		android.os.IInterface iinterface = ibinder.queryLocalInterface("com.amazon.venezia.command.CommandService");
		...
		throws RemoteException
	{
		...
		{
			android.os.IInterface iinterface = ibinder.queryLocalInterface("com.amazon.venezia.command.Command");
		...
		{
			android.os.IInterface iinterface1 = ibinder1.queryLocalInterface("com.amazon.venezia.command.ResultCallback");
