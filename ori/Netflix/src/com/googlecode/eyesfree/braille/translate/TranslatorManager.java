		...
		implements BrailleTranslator
	{
		...
		public String backTranslate(byte abyte0[])
		{
			...
			if (itranslatorservice != null) {
			 s = itranslatorservice.backTranslate(abyte0, mTable);
			}
			} catch(Exception e) {
...
//			throw exception;
	...
	private static final String LOG_TAG = com.googlecode.eyesfree.braille.translate.TranslatorManager.class.getSimpleName();
	private static final int MAX_REBIND_ATTEMPTS = 5;
	private static final int REBIND_DELAY_MILLIS = 500;
	public static final int SUCCESS = 0;// TODO
