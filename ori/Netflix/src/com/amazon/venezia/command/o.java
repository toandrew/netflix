    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int k)
        ...
        case 1: // '\001'
            ...
            if (ibinder3 == null) {
                ...
                android.os.IInterface iinterface3 = ibinder3
                        .queryLocalInterface("com.amazon.venezia.command.SuccessResult");
                if (iinterface3 != null
                        && (iinterface3 instanceof SuccessResult))
        ...
        case 2: // '\002'
            ...
            if (ibinder2 == null) {
                ...
                android.os.IInterface iinterface2 = ibinder2
                        .queryLocalInterface("com.amazon.venezia.command.FailureResult");
                if (iinterface2 != null
                        && (iinterface2 instanceof FailureResult))
        ...
        case 3: // '\003'
            ...
            if (ibinder1 == null) {
                ...
                android.os.IInterface iinterface1 = ibinder1
                        .queryLocalInterface("com.amazon.venezia.command.DecisionResult");
        ...
        if (ibinder == null) {
            ...
            android.os.IInterface iinterface = ibinder
                    .queryLocalInterface("com.amazon.venezia.command.ExceptionResult");
