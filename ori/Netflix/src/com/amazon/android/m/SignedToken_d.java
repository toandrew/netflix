...
public final class SignedToken_d {
    ...
    public SignedToken_d(String s, PublicKey publickey)
            ...
            SignedTokenVerFailureKiwiException_c {
        String s1 = b(s);
        int i = s1.lastIndexOf("|");
        if (i == -1)
            throw com.amazon.android.h.SignedTokenParseFailureKiwiException_b
                    .a();
        String s2 = s1.substring(0, i);
        String s3 = s1.substring(i + 1);
        if (KiwiLogger.TRACE_ON) {
            a.trace((new StringBuilder()).append("Token data: ").append(s2)
                    .toString());
            a.trace((new StringBuilder()).append("Signature: ").append(s3)
                    .toString());
        }
    ...
    private static String b(String s)
        ...
        try {
            ...
            throw new SignedTokenParseFailureKiwiException_b("DECODE",
                    ioexception.getMessage());
        }
        return s1;
    }

    private void c(String s) throws SignedTokenParseFailureKiwiException_b {
        String s2;
        String s3;
        for (StringTokenizer stringtokenizer = new StringTokenizer(s, ","); stringtokenizer
                .hasMoreElements(); b.put(s2, s3)) {
            String s1 = stringtokenizer.nextToken();
            a.trace((new StringBuilder()).append("Field: ").append(s1)
                    .toString());
            int i = s1.indexOf("=");
            if (i == -1)
                throw com.amazon.android.h.SignedTokenParseFailureKiwiException_b
            ...
            s2 = s1.substring(0, i);
            s3 = s1.substring(i + 1);
            a.trace((new StringBuilder()).append("FieldName: ").append(s2)
                    .toString());
            a.trace((new StringBuilder()).append("FieldValue: ").append(s3)
                    .toString());
        }
    ...
    public final String toString() {
        return (new StringBuilder()).append("Signed Token: ").append(b)
                .toString();
    }
