...
public abstract class KiwiException extends Exception {
    ...
    public KiwiException(String s, String s1, String s2) {
        super((new StringBuilder()).append(s).append(": ").append(s1)
    ...
    private static String getContext(Throwable throwable) {
        ...
        stringbuilder.append(getName(throwable)).append(":")
                .append(throwable.getMessage());
        if (throwable != throwable1)
            stringbuilder.append("/").append(getName(throwable1)).append(":")
                    .append(throwable1.getMessage());
    ...
    private static Throwable getRootCause(Throwable throwable) {
        ...
        for (throwable1 = throwable; throwable1.getCause() != null; throwable1 = throwable1
                .getCause())
            ;
        return throwable1;
    }
