...
public final class EventManagerImpl_b implements EventManager_g {
    ...
    public final void a(c c1) {
        ...
        a.trace((new StringBuilder())
                .append("Registering listener for event: ").append(f)
                .append(", ").append(c1).toString());
        EventListenerNotificationQueue_e e1 = (EventListenerNotificationQueue_e) b
                .get(f);
        if (e1 == null) {
    ...
    public final void a(d d1) {
        ...
        if (KiwiLogger.TRACE_ON)
            a.trace((new StringBuilder()).append("Posting event: ").append(f)
                    .toString());
        if (!b.containsKey(f)) {
            if (KiwiLogger.TRACE_ON)
