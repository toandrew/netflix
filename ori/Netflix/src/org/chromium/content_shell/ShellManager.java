...
public class ShellManager extends FrameLayout
{
	...
	private void closeShell(Shell shell)
	{
		...
		FrameLayout framelayout = null;//(FrameLayout)findViewById(R.id.contentview_holder);
		if (contentview != null)
		{
			contentview.destroy();
	...
	{
		Shell shell = null;//(Shell)((LayoutInflater)getContext().getSystemService("layout_inflater")).inflate(R.layout.shell_view, null);
